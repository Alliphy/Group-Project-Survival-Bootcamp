        ...
        <section className="instructorSection">
          ...
          <div className="instructorMasterDiv">
                ...
                >
                  ...
                  <div className="listDiv">
                    ...
                    <li>
                      ...
                      weapons and understanding the enemies&apos;
                      vulnerabilities.{" "}
                    </li>
                    <li>
                      Leadership and teamwork: Demonstrates exceptional
            ...
            <p>
              ...
              harrowing experience on LV-426, Ripley found herself haunted by
              the memories of the creatures she had faced. Driven by a desire to
              ...
              <div>
                ...
                >
                  ...
                  <div className="listDiv">
                    ...
                    <li>
                      Resilience and determination: Unwavering spirit in the
                      face of adversity. Show no fear in the face of adversary.
                    </li>
                  </div>
                </div>
              </div>
        ...
        <section className="instructorSection">
          ...
          <div className="instructorMasterDiv">
              ...
              <div>
                ...
                >
                  ...
                  <div className="listDiv">
                    ...
                    <li>
                      Quick thinking and adaptability: Capacity to devise
            ...
            <p>
              ...
              undead have honed his skills in combat, weaponry, and quick
              thinking. Ash&apos;s infectious personality and unconventional
              approach to survival make him an entertaining and informative
              instructor.
            </p>
          </div>
        </section>
        ...
        <section className="instructorSection">
          ...
          <div className="instructorMasterDiv">
              ...
              <div>
                ...
                >
                  ...
                  <div className="listDiv">
                    ...
                    <li>
                      Spiritual understanding: Deep understanding of the nature
                      of good and evil. Ability to discern between friendly or
                      unfriendly entities.
                    </li>
                    <li>
            ...
            <p>
              ...
              them a unique perspective on the world of ghosts, demons, and
              other supernatural entities. The Warrens&apos; knowledge of
              exorcisms, spiritual protection, and the history of hauntings make
              them invaluable guides for anyone facing the unknown.
            </p>
          </div>
        </section>
        ...
        <section className="instructorSection">
          ...
          <div className="instructorMasterDiv">
            ...
            <p>
              ...
              seemingly normal family has taught him the importance of trust,
              observation, and self-preservation. Chris&apos;s ability to think
              critically and identify hidden dangers makes him the perfect guide
              for anyone navigating the potentially perilous world of suburbia.
            </p>
          </div>
        </section>
